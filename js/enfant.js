...
function SetPageEnfant(name) {
    ...
    document.getElementById("facebook_enfant").href = "https://www.facebook.com/sharer/sharer.php?u=https://white-nightingale.cloudvent.net/" + "?&enfant=" + name + "&quote=Ensemble, agissons pour " + name + "!";
