...
function SetPageEnfant(name) {
    ...
    document.getElementById("facebook_enfant").href = "https://www.facebook.com/sharer/sharer.php?u=https://jepasselespoir.chainedelespoir.org/&quote=Passez l'espoir et sauvez des vies.&hashtag=jepasselespoir";
    document.getElementById("twitter_enfant").href = "https://twitter.com/intent/tweet?url=https://jepasselespoir.chainedelespoir.org/&text=Passez l'espoir et sauvez des vies.&hashtag=jepasselespoir";
