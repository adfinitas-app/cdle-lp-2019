...
function SetPageEnfant(name) {
	...
	document.getElementById("facebook_enfant").href =
		"https://www.facebook.com/sharer/sharer.php?u=https://jepasselespoir.chainedelespoir.org/&quote=Passez l'espoir et sauvez des vies. %23jepasselespoir";
	document.getElementById("twitter_enfant").href =
		"https://twitter.com/intent/tweet?url=https://jepasselespoir.chainedelespoir.org/&text=Passez l'espoir et sauvez des vies.&hashtags=jepasselespoir";

	var mahdiText = [
		"grâce à vous,<br>mahdi",
		"va être pris<br>en charge",
		"mahdi, 17 mois, Mauritanie",
		"Pathologie : Malformation faciale",
		"une malformation rare",
		"mahdi est un petit garçon mauritanien né avec une grave malformation faciale, aussi rare que terrible : une macrostomie congénitale bilatérale, en d'autres termes une large fente qui lui déchire le visage.Âgé de 17 mois, il vit près de Nouadhibou, une petite ville située à plus de 399 km de la capitale.",
		"Sa famille, qui vit dans<br> une grande précarité,<br> ne peut rien pour lui.",
		"une solution existe",
		"Les parents de mahdi n'ont qu'un vœu en cette fin d’année : que leur enfant soit pris en charge afin de lui donner une nouvelle vie…",
		"Heureusement, une solution chirurgicale existe ; ",
		"nous pouvons éliminer la souffrance de ce petit garçon. Trois opérations complexes seront nécessaires : la première refermera la fente du palais, à l’intérieur de la bouche ; la deuxième soignera les fentes qui atteignent la face inférieure de l’enfant ; enfin, la dernière intervention pourra redessiner son visage.",
	];
	var andyText = [
		"andy a<br>besoin de vous,<br>",
		"aidez-le",
		...
		"<br><br>Vous pouvez<br>changer les choses",
	...
	var nithaText = [
		...
		"<br><br>Soutenez Nitha<br>et aidez-la à guérir",
	...
	var ayoText = [
		...
		"<br><br>Aidez Ayo à être soignée et à réaliser son rêve",
	...
	var baianText = [
		...
		"<br><br>Un premier traitement échoué",
	...
	var mahdiText = [
		"offrons à<br>mahdi un sourire,<br>",
		"et la vie",
		"mahdi, 1 an, mali",
		"fente labiale",
		"600 €*",
		"Ses parents sont très inquiets",
		"<br>Mahdi vit avec ses parents et ses trois sœurs dans la région de Kayes, au Mali. À sa naissance, sa maman a immédiatement remarqué une malformation au niveau de sa bouche. Tellement paniquée, elle n'a pas osé allaiter son enfant. Pour cause, en Afrique les malformations sont synonymes de malédictions et les rumeurs se répandent très vite. Accoucher d’un nouveau-né atteint d’un bec de lièvre implique donc une peur de se voir exclus de sa communauté, et surtout, de voir son enfant se faire bannir de tous.<br><br><div class='container-fluid'    style='height: auto; width: 100%; background-color: black; position: relative; background-size: cover; padding: 0;'    id='video_mahdi_div'>    <video width='100%' height='auto' id='video_mahdi' poster='assets/posterMahdi.png'>        <source src='assets/videoMahdi.mp4' type='video/mp4' />    </video>    <div style='position: absolute; top: 0; right: 0; bottom: 0; left: 0; height: 60px; width: 60px; margin: auto; border-radius: 50px; cursor: pointer;'        class='jaune_bg play_button_video' id='ButtonMahdi'>        <img src='assets/play.png' height='50%'            style='position: absolute; top: 0; right: 0; bottom: 0; left: 0; margin: auto;'>    </div></div><br><br>Les parents de Mahdi ont immédiatement consulté un tradi-praticien qui leur a conseillé d’emmener leur fils au Centre Hirzel, à Bamako, une structure spécialisée dans la prise en charge d’enfants nécessitant une chirurgie de la face. Une fois au Centre, après plusieurs heures de taxi brousse, les équipes médicales ont diagnostiqué chez Mahdi une fente labio-alveolo-palatine unilatérale droite, autrement-dit un « bec de lièvre », qui limite son alimentation et retarde sa croissance :",
		"le lait ne peut être ingéré normalement, une grande partie du liquide ressortant par son nez.",
		"<br><br>LA SITUATION POUR MAHDI EST GRAVE",
		"Agé d'à peine un an, Mahdi a besoin d'apports nutritionnels importants pour vivre. Seule une intervention chirurgicale permettra à Mahdi de s'alimenter correctement.<br><br><br><span id='black_title_text_2' class='uppercase noir_pur bold' style='font-size: 25px; line-height: 22px;'>NOUS POUVONS CHANGER SA VIE</span><br>Contrairement à de nombreux enfants qui naissent avec cette malformation, Mahdi a la chance d’être entouré par toute sa famille. Les rumeurs africaines qui assimilent les fentes labiales à l’œuvre du démon n’ont donc pas d’emprise sur l’amour qui lui est déjà porté, ce qui fait de lui un petit garçon joyeux et plein de vie.<br>Mais ses parents, aux moyens financiers limités ne peuvent surmonter les frais d’une telle opération.<br><br>Avec un don, vous contribuerez à soigner Mahdi et vous changerez le destin de toute une famille !",
	];
	var doumaText = [
		"L’ŒSOPHAGE BRÛLÉ,<br>",
		"douma est en<br>grave danger",
		"douma, 5 ANS, Tchad",
		"sténose caustique de<br>l’œsophage",
		"5 000 €",
		"un accident très<br> fréquent en afrique",
		"<br>Il y a un an, un accident domestique malheureusement très fréquent en Afrique s’est produit dans la ville d’Abéché au Tchad. Douma, petit Tchadien de 5 ans a voulu étancher sa soif en s’emparant d’une bouteille. Hélas, ce qu’il pensait être de l’eau était en réalité un produit ménager très corrosif : la soude caustique. L’ingestion de cette substance a brûlé une partie de son œsophage, provoquant des lésions irréversibles et extrêmement douloureuses. Depuis l’incident, Douma ne peut plus rien avaler et son état de santé s’aggrave de jour en jour.",
		"",
		"UN LONG VOYAGE POUR SOIGNER DOUMA",
		"Alarmés par les cris de Douma, ses parents se sont vite rendus à l’hôpital de N’Djamena, capitale du Tchad, pour lui prodiguer les premiers soins. Sur place, en constatant l’ampleur de la brûlure, les médecins ont référé le petit Douma à l’Hôpital de Khartoum au Soudan, le seul de la région capable de réaliser une dilatation œsophagienne. Cette intervention consiste à descendre des bougies de tailles différentes dans le tube digestif pour dilater les parois et rouvrir l’œsophage.<br><br>Malgré la distance, les parents de Douma ont pris la route vers le Soudan dans l’espoir de sauver leur fils. Le voyage en taxi-brousse fut très pénible pour tous, surtout pour Douma, dont les douleurs s’accentuaient avec ce long trajet.<br><br>À l’hôpital de Khartoum, Douma a subi trois interventions successives pour dilater son œsophage. Cependant, des complications sont survenues rendant toute tentative de dilatation impossible. Il a fallu vite réagir et trouver une solution transitoire lui permettant de survivre : une sonde dans son estomac pour l’alimenter.<br><br>Grâce à cette sonde, ses parents peuvent le nourrir en injectant chaque jour une bouillie.<br><br><span id='yellow_text_1' class='jaune'                                      style='font-style: italic; font-size: 25px; font-weight: 600; line-height: 30px;'>Cela fait maintenant 8 mois que Douma est alimenté par une sonde. Mais celle-ci ne suffit pas pour sauver le petit Tchadien, actuellement sous-alimenté.</span><br><br>L’unique solution pour le sauver est une chirurgie complexe et très coûteuse pour la famille : le remplacement de la portion de son œsophage brûlé. Or, pour bénéficier de cette opération, Douma doit d’abord reprendre du poids et être suivi médicalement. À 5 ans, il fait le poids d’un enfant de 18 mois !<br><br>Mais cette opération ne peut se faire ni au Soudan, ni au Tchad, faute d’un plateau technique adapté.<br><br><span id='black_title_text_2' class='uppercase noir_pur bold' style='font-size: 25px; line-height: 22px;'>IL EST ENCORE TEMPS DE LE SAUVER</span><br>Heureusement, Douma a été repéré par notre équipe de médecins bénévoles et une mission chirurgicale est organisée en Côte d’Ivoire fin janvier 2020. Si nous arrivons à collecter la somme nécessaire pour financer les frais d’opération et de suivi médical, le petit garçon pourra être transféré en Côte d’Ivoire et être opéré dans le cadre de cette mission.<br><br>Ensemble, sauvons Douma !",
		"Heureusement, une solution chirurgicale existe ; ",
		"nous pouvons éliminer la souffrance de ce petit garçon. Trois opérations complexes seront nécessaires : la première refermera la fente du palais, à l’intérieur de la bouche ; la deuxième soignera les fentes qui atteignent la face inférieure de l’enfant ; enfin, la dernière intervention pourra redessiner son visage.",
	];
	...
	var idList = [
		"#title_enfant_jaune",
		"#title_enfant_noir",
		"#sous_title_enfant_jaune_1",
		"#sous_title_enfant_jaune_2",
		"#sous_title_enfant_jaune_3",
		"#black_title_text_1",
		"#black_text_1",
		"#yellow_text_1",
		"#black_title_text_2",
